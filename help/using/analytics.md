...
seo-description: La page décrit les analyses avec AEM Screens.
...
Nous pouvons utiliser ces données pour créer une carte de chaleur d’une expérience interactive afin de déterminer la carte de parcours préférée dans notre application. Nous pouvons également choisir de créer un tableau de bord qui représente, sous forme graphique, le nombre de fois où les consommateurs interagissent avec notre application.
