...
1. **Création de segments dans les audiences**
   ...
   1. Cliquez sur l’onglet **Personnalisation** dans **Propriétés du segment**. Définissez le **Chemin d’accès ContextHub** sur `/conf/screens/settings/cloudsettings/ContextHubDemo/contexthub configurations` et le **Chemin d’accès aux segments** sur `/conf/screens/settings/wcm/segments`, puis cliquez sur **Enregistrer**, comme illustré dans la figure ci-dessous.
...
1. **Modification des segments**
   ...
   1. Cliquez sur **googlesheets/value/1/0** dans la liste déroulante du **Nom de la propriété**.
