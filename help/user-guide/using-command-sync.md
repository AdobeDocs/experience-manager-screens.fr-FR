...
Une fois que vous avez synchronisé un ou plusieurs appareils avec un maître, vous pouvez les désynchroniser. Pour annuler la synchronisation avec l’appareil maître, procédez comme suit :
