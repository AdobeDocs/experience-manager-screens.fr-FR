...
>[!NOTE]
>
>Pour en savoir plus sur le lecteur AEM Screens, consultez les ressources suivantes :Téléchargements du lecteur AEM ScreensUtiliser le lecteur AEM Screens](working-with-screens-player.md)
