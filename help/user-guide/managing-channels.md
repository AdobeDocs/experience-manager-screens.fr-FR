...
Cliquez sur (**...**) à partir de la barre d’actions **INFORMATIONS SUR LE CANAL**, vous pouvez afficher les propriétés, modifier le contenu ou mettre à jour le cache (contenu hors ligne) du canal.
