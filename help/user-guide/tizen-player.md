...
1. Accédez à **network** > **Nom de l’appareil** pour attribuer un nom au lecteur.

### Configuration des mises à jour sur l’appareil Samsung {#config-updates}

Suivez les étapes ci-dessous sur l’appareil Samsung pour effectuer l’installation du lecteur AEM Screens :
...
1. Accédez à l’onglet **Device** (Appareil) et recherchez l’appareil que vous venez de configurer. Une fois l’appareil trouvé, cochez la case et sélectionnez **Approve** (Approuver).

   >![image](/help/user-guide/assets/tizen/rms-3.png)

1. Renseignez les informations requises et sélectionnez un groupe d’appareils. Cliquez sur **OK** pour terminer le processus d’approbation.

   >![image](/help/user-guide/assets/tizen/rms-7.png)

1. Une fois l’appareil approuvé, il doit apparaître dans la liste des appareils. Cliquez sur le bouton *Information* situé dans l’icône de votre appareil, c’est-à-dire le **i**, comme indiqué dans l’image ci-dessous.

   >![image](/help/user-guide/assets/tizen/rms-6.png)

1. La boîte de dialogue présentant les informations sur l’appareil s’affiche. Sélectionnez l’onglet **Device Info** (Informations sur l’appareil) et cliquez sur **Edit** (Modifier).

   >![image](/help/user-guide/assets/tizen/rms-5.png)

1. Modifiez les options de l’appareil et sélectionnez l’onglet **Setup** (Configuration). Accédez à la section **URL Launcher** (Lancement d’URL) et saisissez l’URL hébergeant le wgt et le `SSSP config file` pour installer une application `SSSP`, comme illustré dans la figure ci-dessous.
